...
import com.example.mynoteapps.databinding.ActivityAddNoteUpdateBinding
import com.example.mynoteapps.helper.DateHelper
import com.example.mynoteapps.viewmodel.NoteAddUpdateViewModel
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private var _activityNoteAddUpdateBinding: ActivityAddNoteUpdateBinding? = null
    private val binding get() = _activityNoteAddUpdateBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _activityNoteAddUpdateBinding = ActivityAddNoteUpdateBinding.inflate(layoutInflater)
